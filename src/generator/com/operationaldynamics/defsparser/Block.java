...
public abstract class Block
{
    ...
    /**
     * Return the C name of this Block.
     * 
     * @return the Block C name.
     */
    ...
    /**
     * Return the ofObject field value of this Block.
     * 
     * @return the ofObject field value or null if not found.
     */
    public final String getOfObject() {
        ...
        while (target != Object.class) {
            ...
            for (Field field : fields) {
                if (field.getName().equals("ofObject")) {
                    try {
                        return (String) field.get(this);
                    } catch (IllegalArgumentException e) {
                        e.printStackTrace();
    ...
    /**
     * Return the isConstructorOf field value of this Block.
     * 
     * @return the isConstructorOf field value or null if not found.
     */
    public final String getIsConstructorOf() {
        ...
        while (target != Object.class) {
            ...
            for (Field field : fields) {
                if (field.getName().equals("isConstructorOf")) {
                    try {
                        return (String) field.get(this);
                    } catch (IllegalArgumentException e) {
                        e.printStackTrace();
     ...
     * additional supporting information of what class it fits into.
     */
